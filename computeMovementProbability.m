...
pdFlag = false(Ntr, Nccond, Nbs); pmFlag = pdFlag; mvFlag = pdFlag;
pk_dist = cell(Ntr, Nccond, Nbs); rosFlag = pk_dist; froFlag = pdFlag;
...
movStruct = struct('MovmentFlags', mvFlag, 'FirstMovement', frstPk_all, ...
    'TrialOrder', trOrd, 'MedianFlag', pmFlag, 'DispersionFlag', pdFlag, ...
    'PeakOutlierFlag', froFlag, 'RangeFlag', rgFlag);
end